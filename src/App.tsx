      ...
      <div className="min-h-screen bg-dark flex items-center justify-center p-4">
        <div className="bg-dark-blue rounded-xl shadow-glow max-w-4xl w-full p-8 text-center border border-teal/20">
          ...
          <p className="text-lg text-gray mb-6">
            Your insights will help us develop better BIM solutions that address real industry needs.
          </p>
          <button 
    ...
    <div className="min-h-screen bg-dark">
      ...
      <section className="py-20 px-4 relative overflow-hidden">
        ...
        <div className="max-w-7xl mx-auto text-center relative z-10">
          <h1 className="text-5xl md:text-6xl font-bold text-teal mb-6 leading-tight">Help Shape the Future of BIM Technology</h1>
          <p className="text-xl text-gray max-w-3xl mx-auto mb-10">
            We're exploring innovative ways to leverage Unreal Engine and BIM models to provide 
      ...
      <section className="py-16 bg-dark-blue" id="about">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <h2 className="section-title text-center">Exploring Next-Gen BIM Solutions</h2>
          ...
          <div className="grid md:grid-cols-3 gap-8">
            <div className="card group">
              ...
              <h3 className="text-xl font-semibold mb-3 text-teal-dark group-hover:text-teal transition-colors">Multi-Dimensional BIM</h3>
            ...
            <div className="card group">
              ...
              <h3 className="text-xl font-semibold mb-3 text-teal-dark group-hover:text-teal transition-colors">Unreal Engine Integration</h3>
              <p className="text-gray">
                Leveraging game engine technology for immersive visualization and real-time collaboration.
              </p>
            </div>
            ...
            <div className="card group">
              ...
              <p className="text-gray">
                Turning complex BIM data into actionable insights through sophisticated analysis tools.
              </p>
            </div>
          </div>
        </div>
      ...
      <section className="py-16 px-4" id="survey">
        <div className="max-w-4xl mx-auto bg-dark-blue rounded-xl shadow-lg p-8 border border-teal-dark/30">
          <h2 className="section-title">BIM Applications Survey</h2>
          <p className="text-gray mb-8">
            Please share your thoughts to help us develop BIM solutions that address your specific needs.
          </p>
          ...
          <form onSubmit={handleSubmit}>
            ...
            {/* Current BIM Usage */}
            <div className="mb-10">
              <h3 className="text-xl font-semibold mb-4 pb-2 border-b border-teal-dark/30 text-teal-dark">Current BIM Usage</h3>
              
              <div className="mb-6">
                <p className="block text-sm font-medium text-gray mb-2">Which BIM tools do you currently use? (Select all that apply)</p>
              ...
              <div>
                <label htmlFor="challenges" className="block text-sm font-medium text-gray mb-1">
                  What challenges do you face with your current BIM workflow?
                </label>
                <textarea
                  id="challenges"
                  name="challenges"
            ...
            {/* Future BIM Needs */}
            <div className="mb-10">
              <h3 className="text-xl font-semibold mb-4 pb-2 border-b border-teal-dark/30 text-teal-dark">Future BIM Needs</h3>
              
              <div className="mb-6">
                <p className="block text-sm font-medium text-gray mb-2">Which features would be most valuable in a next-gen BIM solution? (Select all that apply)</p>
              ...
              <div className="mb-6">
                <label htmlFor="dataVisualization" className="block text-sm font-medium text-gray mb-1">
                  How important is advanced data visualization in your BIM workflow?
                </label>
                <select
              ...
              <div className="mb-6">
                <label htmlFor="unreal" className="block text-sm font-medium text-gray mb-1">
                  Have you used Unreal Engine for visualization in your projects?
                </label>
                <select
                  id="unreal"
                  name="unreal"
                ...
                >
                  ...
                  <option value="Tried it but not regularly">Tried it but not regularly</option>
                  <option value="Use it occasionally">Use it occasionally</option>
                  <option value="Use it frequently">Use it frequently</option>
                </select>
              </div>

              <div>
                <label htmlFor="additionalComments" className="block text-sm font-medium text-gray mb-1">
                  Any additional comments or suggestions for our BIM solution?
                </label>
                <textarea
      ...
      <section className="py-16 bg-dark-blue">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <h2 className="section-title text-center">Potential BIM Applications</h2>
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-8">
            <div className="card group">
              ...
              <p className="text-gray">
                Photorealistic rendering and immersive walkthroughs using Unreal Engine to communicate design intent.
              </p>
            </div>
            ...
            <div className="card group">
              <div className="flex items-center mb-4">
                ...
                <h3 className="text-xl font-semibold text-teal-dark group-hover:text-teal transition-colors">Multi-dimensional BIM</h3>
              </div>
              <p className="text-gray">
                Integrating cost (5D), sustainability (6D), and facility management (7D) data into BIM models.
              </p>
            </div>
          </div>
        </div>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="grid md:grid-cols-3 gap-8">
            <div>
              ...
              <p className="text-gray">
                Helping shape the future of BIM technology through industry feedback and innovation.
              </p>
            </div>
            ...
            <div>
              ...
              <p className="text-gray mb-2">Have questions about our BIM solutions?</p>
              <a 
